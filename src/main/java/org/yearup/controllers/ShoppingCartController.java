...
public class ShoppingCartController
{
    ...
    public ShoppingCart updateQuantity(@PathVariable int id, @RequestBody ShoppingCartItem quantity, Principal principal){
        try{
            // get the currently logged in username
            String userName = principal.getName();
            // find database user by userId
            ...
            shoppingCartDao.updateQuantity(userId, id, quantity.getQuantity());
